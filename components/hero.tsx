...
export default async function Hero() {
  ...
  return (
    <>
      ...
      <section className="fixed right-0 top-6 z-20 flex h-20 w-64 items-center justify-end">
        <a
          className="absolute mr-8 rounded-xl border border-[#325c59] border-opacity-0 px-5 py-2.5 text-base font-medium tracking-widest underline transition-all duration-200 hover:border-opacity-100 hover:bg-[#ece8f5] hover:no-underline"
